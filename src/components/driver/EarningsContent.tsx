...
import { EstadisticasConductor, Transaccion } from '@/interfaces';

interface EarningsContentProps {
  stats: EstadisticasConductor;
  transacciones: Transaccion[];
}

export function EarningsContent({ stats, transacciones }: EarningsContentProps) {
