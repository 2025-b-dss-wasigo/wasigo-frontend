...
export function MyRoutesContent({ rutasActivas, rutasPausadas, stats }: MyRoutesContentProps) {
  ...
  const RouteCard = ({ route, isPaused = false }: { route: Ruta, isPaused?: boolean }) => (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-(--primary)">{stats.rutasActivas}</p>
            <p className="text-sm text-(--muted-foreground)">Rutas Activas</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-(--foreground)">{stats.viajesCompletados}</p>
            <p className="text-sm text-(--muted-foreground)">Viajes Totales</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-emerald-500">${stats.gananciasMes.toFixed(2)}</p>
            <p className="text-sm text-(--muted-foreground)">Ganancias Mes</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-amber-500">{stats.calificacion.toFixed(1)}</p>
