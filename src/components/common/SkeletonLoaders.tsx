          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex-1 space-y-2">
                  <div className="h-5 bg-gray-100/50 dark:bg-gray-500/30 rounded w-48"></div>
                  <div className="h-4 bg-gray-100/50 dark:bg-gray-500/30 rounded w-64"></div>
                </div>
                <div className="h-8 bg-gray-100/50 dark:bg-gray-500/30 rounded w-20"></div>
              </div>
              <div className="flex items-center justify-between pt-2">
                <div className="h-4 bg-gray-100/50 dark:bg-gray-500/30 rounded w-40"></div>
                <div className="h-8 bg-gray-100/50 dark:bg-gray-500/30 rounded w-16"></div>
              </div>
            </div>
          </CardContent>
        </Card>
  ...
  return (
    <div className="card-elevated">
      <div className="p-4 border-b border-border flex items-center justify-between animate-pulse">
        <div className="h-6 bg-gray-100/50 dark:bg-gray-500/30 rounded w-48"></div>
        <div className="h-10 bg-gray-100/50 dark:bg-gray-500/30 rounded w-20"></div>
      </div>
      ...
      <div className="divide-y divide-border">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="p-4 flex items-center justify-between animate-pulse">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gray-100/50 dark:bg-gray-500/30"></div>
              <div>
                <div className="h-4 bg-gray-100/50 dark:bg-gray-500/30 rounded w-32 mb-2"></div>
                <div className="h-3 bg-gray-100/50 dark:bg-gray-500/30 rounded w-48"></div>
              </div>
            </div>
            <div className="h-5 bg-gray-100/50 dark:bg-gray-500/30 rounded w-20"></div>
          </div>
        ))}
      </div>
    </div>
...
export function DriverRequestsListSkeleton() {
  return (
    <Card>
      <CardHeader>
...
export function PayoutsListSkeleton() {
  return (
    <Card>
      <CardHeader>
        <div className="h-6 bg-gray-200 rounded w-48 mb-2 animate-pulse"></div>
